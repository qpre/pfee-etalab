...
(function() {
  ...
  $.fn.extend({
    leaftr: function(options) {
      ...
      return $.ajax('http://cow.etalab2.fr/api/1/datasets/related', {
        type: 'GET',
        dataType: 'json',
  ...
  Leaftr = (function() {
    ...
    Leaftr.prototype.display_div = function(tile) {
      ...
      if (name.length > this.options.max_description_length) {
        name = name.substr(0, this.options.max_description_length) + '...';
      }
      return this.div.append("<a target='_blank' href='" + url + "'><div class='leaftr-tile'><img src='" + img + "'><div class='tile-hover'>" + name + "</div></div></a>");
    };
